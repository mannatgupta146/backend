...
const Login = () => {
    ...
    const {register, handleSubmit, onLoginSubmit, errors, showPassword, setShowPassword, isSubmitting} = useAuth()
    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-neutral-50 p-4 font-sans text-neutral-900">
      <div className="w-full max-w-md bg-white border border-neutral-200 rounded-xl p-8 shadow-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-neutral-500 text-sm mt-1">Enter your credentials to access your account</p>
        </div>
